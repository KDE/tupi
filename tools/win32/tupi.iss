...
Root: HKCR; Subkey: "TupiOpen2DMagic\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\tupi.ico,0" 
Root: HKCR; Subkey: "TupiOpen2DMagic\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\tupi.exe"" ""%1""" 
